...
summary: "Say hello to 3d.bimadev.xyz — a free and simple tool to generate 3D models easily for your projects."
images:
...
Let me introduce [3D Model Generator](https://3d.bimadev.xyz) — a fun and simple tool to generate 3D models instantly, right from your browser.
...
→ [3d.bimadev.xyz](https://3d.bimadev.xyz)
